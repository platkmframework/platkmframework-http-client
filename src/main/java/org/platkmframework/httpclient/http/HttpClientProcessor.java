...
public final class HttpClientProcessor extends HttpClientService {
     ...
     */
    /**
     * Atributo httpClientProcessor
     */
    private static HttpClientProcessor httpClientProcessor;

    /**
     * Constructor HttpClientProcessor
     */
     ...
     * process
     * @param url url
     * @param mapQueryParam mapQueryParam
     * @param body body
     * @param httpMethod httpMethod
     * @param isAnyc isAnyc
     * @param futureCallBack futureCallBack
     * @param restInfo restInfo
     * @param returnType returnType
     * @return Object
     * @throws HttpClientError HttpClientError
     * @throws HttpClientAttemptError HttpClientAttemptError
     */
    public Object process(String url, Map<String, String> mapQueryParam, Object body, HttpRequestMethod httpMethod, boolean isAnyc, FutureCallback<HttpResponse> futureCallBack, RestInfo restInfo, Class<?> returnType) throws HttpClientError, HttpClientAttemptError {
        try {
            if (isAnyc) {
                ...
                if (returnType.equals(Void.TYPE))
                    return null;
                if (returnType.getName().equals(ResponseInfo.class.getName()))
                    return responseInfo;
     ...
     * @param returnClassType returnClassType
     * @return E
